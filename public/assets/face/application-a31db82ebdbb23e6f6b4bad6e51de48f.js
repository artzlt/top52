...
(function() {
  $(function() {
    return google.setOnLoadCallback(function() {
      var height, titleTextStyle, width;
      width = 720;
      height = 300;
      titleTextStyle = {
        fontSize: 18
      };
      $('.graph-pie').each(function(i, html) {
        var $graph, chart, data, options, source;
        $graph = $(html);
      ...
      $('.graph-bar').each(function(i, html) {
        var $graph, chart, data, options, source, table;
        $graph = $(html);
        table = [];
        source = $graph.data('source');
        data = new google.visualization.DataTable();
      ...
      return $('.cohort').each(function(i, html) {
        return setTimeout(function() {
          var $graph, chart, data, options;
          $graph = $(html);
